...
public class App114 {
  public static void main(String[] args){
    ...
    hashMap.put("1", new Student("2021050489", "Nguyen Thi Kim Nhan", "C2"));
    hashMap.put("2", new Student("2021050492", "Nguyen Duc Nhat", "C2"));
    hashMap.put("3", new Student("2021050493", "Nguyen Van Nhat", "C2"));
    hashMap.put("4", new Student("2021050497", "Nguyen Hong Nhung", "C2"));
